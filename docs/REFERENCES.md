...
| Opflasher off-air ACARS + VDL2 captures (Airframes Discord) | contributed for benchmarking, with thanks | Real-RF VHF captures (complex float32, 3.0 MS/s). ACARS used for the acarsdec head-to-head + CI count gate (`bench/data/acars_24k.cs16`, a downconverted slice — real Korean Air HL8537 traffic; xng 13 vs acarsdec 3.7 9). VDL2 capture pending parameter confirmation (BENCH-2). | Airframes Discord (#contributors) |
