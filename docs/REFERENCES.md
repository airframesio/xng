...
| Opflasher off-air ACARS + VDL2 captures (Airframes Discord) | contributed for benchmarking, with thanks | Real-RF VHF captures (complex float32). **ACARS** (3.0 MS/s) → acarsdec head-to-head + CI gate (`bench/data/acars_24k.cs16`, real Korean Air HL8537; xng 13 vs acarsdec 3.7 9). **VDL2** (2.5 MS/s) → dumpvdl2 head-to-head + CI gate (`bench/data/vdl2_opflasher_105k.cs16`, real Air NZ ZK-NNB ADS-C-over-VDL2; xng 13 vs dumpvdl2 2.6.0 12). | Airframes Discord (#contributors) |
