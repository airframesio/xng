...
- [ ] **ECO-4** REST / data API — ✅ **`/data/aircraft.json` + `/data/receiver.json`** served off the dashboard port (2026-06-18: readsb field schema — hex/flight/r/t/alt_baro/gs/track/squawk/nac_p/sil/version/lat/lon/seen/seen_pos/messages — merged across ADS-B/UAT/HFDL by ICAO; receiver.json carries version + `receiver-pos`; makes xng a drop-in for tar1090/graphs1090/VRS); ❌ remaining: filtered/incremental `?since=`; WebSocket/SSE/delta
